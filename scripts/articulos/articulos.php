<?php
    ...
    $Reg_articulos = $conexion->query( "INSERT into $empresa.tbl_articulos (nombre, precio, precio_compra, descripcion, codigo_barra, cod_impuesto, stop_min, cantidad_disponible, categoria, unidad, status)
